...
5. **Release APK / signing.** The release APK was built from this branch (run
   ...
   Agreed with the owner: keep it unsigned for now and install the CI debug APK
   (`android-apk-debug` from run `36209081618`) instead.
